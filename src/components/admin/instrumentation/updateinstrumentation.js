...
const Updateinstrumentation = () => {
  ...
  const updateinstrumentation = async (e) => {
    e.preventDefault();
      ...
      >
        ...
        <Container>
          <div className="d-flex vh-100  justify-content-center align-items-center">
            ...
            >
              <Form onSubmit={updateinstrumentation}>
                <Form.Group>
...
export default Updateinstrumentation;
