...
const ValvesProduct = () => {
  ...
  useEffect(() => {
    AXIOS.get(`http://orion-frontend-api.vercel.app/getValvesProduct/${id}`)
      .then((result) => {
        console.log(result);
  ...
  const handleFormSubmit = async () => {
    await AXIOS.post("http://orion-frontend-api.vercel.app/Valves", {
