        ...
        <div className="container">
          ...
          <div className="row">
            <ServiceItem
              icon="pe-7s-arc"
              title="Versatility"
              desc="OGT refers to the wide-ranging and adaptable nature of the products and solutions offered."
            />
            <ServiceItem
              icon="pe-7s-cloud-download"
              title="Affordability"
              desc="OGT signifies the commitment to delivering cost-effective solutions to clients. "
            />
            <ServiceItem
              icon="pe-7s-disk"
              title="Expertise"
              desc="OGT reflects the wealth of knowledge and experience embedded in the company's services"
            />
            <ServiceItem
              icon="pe-7s-hammer"
              title="Reliability"
              desc="OGT signifies the company's commitment to consistent and trustworthy services."
            />
            <div className="text-center mt-60">
              <Link to="/service-details" className="tp-btn-border">
                All Service
                <span>
                  <svg
                    width="22"
