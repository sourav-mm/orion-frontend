...
function Fittings() {
  ...
  const allData = () => {
    const URL = "http://localhost:9000/getaddfittings/";
    AXIOS.get(URL)
              ...
              {addprd.map((addprd) => (
                ...
                >
                  ...
                  <Card.Body>
                    ...
                    <Link to={`/FittingsProduct/${addprd._id}`}>
                      <Button
                        variant="primary"
