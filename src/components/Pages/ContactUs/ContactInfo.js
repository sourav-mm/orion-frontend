          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="ct-info__box text-center pt-50 pb-50 mb-30">
                ...
                <p className="p-0">
                  Office: 11th FLOOR, FUJAIRAH TOWER, FUJAIRAH, UAE Warehouse:
                  P.O. BOX 380575 RAS AL KHOR DUBAI
                </p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="ct-info__box text-center pt-50 pb-50 mb-30">
                ...
                <p className="p-0">
                  <a href="tel:+1255-568-6523">Tel : +9714 283 1148</a> <br />
                  <a href="tel:+1255-568-6523">Mob : +97155 999 7283</a>
                </p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="ct-info__box text-center pt-50 pb-50 mb-30">
                ...
                <p className="p-0">
                  <a href="mailto:email@example.com"> sales@orionworld.co</a>{" "}
                  <br />
