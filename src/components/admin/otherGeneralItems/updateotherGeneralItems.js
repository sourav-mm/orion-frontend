...
const UpdateotherGeneralItems = () => {
  ...
  const updateotherGeneralItems = async (e) => {
    e.preventDefault();
    ...
    try {
      ...
      navigate("/editotherGeneralItems");
    } catch (error) {
      ...
      >
        ...
        <Container>
          <div className="d-flex vh-100  justify-content-center align-items-center">
            ...
            >
              <Form onSubmit={updateotherGeneralItems}>
                <Form.Group>
...
export default UpdateotherGeneralItems;
