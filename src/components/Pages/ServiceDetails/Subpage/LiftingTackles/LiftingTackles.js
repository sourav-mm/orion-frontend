...
import "./LiftingTackles.css";
import FavoriteBorderIcon from "@mui/icons-material/FavoriteBorder";

function LiftingTackles() {
              ...
              {addprd.map((addprd) => (
                ...
                >
                  ...
                  <Card.Body>
                    ...
                    <Link to={`/LiftingTacklesProduct/${addprd._id}`}>
                      <Button
                        variant="primary"
