                ...
                <div key={item.id}>
                  ...
                  >
                    <div className="tp-slider-text black-bg d-inline-block">
                      ...
                      <h3 className="tp-slider-title" style={{ fontSize: '42px' }}>
                        {item.subTitle1} 
                      </h3>
                      <span className="mb-15 d-inline-block" style={{fontSize:'20px'}}>{item.para1}</span>
                      <span className="mb-15 d-inline-block" style={{fontSize:'14px'}}>{item.para2}</span><br/>
