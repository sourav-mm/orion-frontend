...
const UpdateelectroMechanical = () => {
  ...
  useEffect(() => {
    AXIOS.get("http://orion-frontend-api.vercel.app/getupdateelectroMechanical/" + id)
      .then((result) => {
        console.log(result);
  ...
  const updateelectroMechanical = async (e) => {
    e.preventDefault();
    ...
    try {
      const response = await AXIOS.put(
        `http://orion-frontend-api.vercel.app/updateelectroMechanical/${id}`,
        formData
      );
  
      alert(response.data.msg15);
      navigate("/editelectroMechanical");
    } catch (error) {
      ...
      >
        ...
        <Container>
          <div className="d-flex vh-100  justify-content-center align-items-center">
            ...
            >
              <Form onSubmit={updateelectroMechanical}>
                <Form.Group>
...
export default UpdateelectroMechanical;
