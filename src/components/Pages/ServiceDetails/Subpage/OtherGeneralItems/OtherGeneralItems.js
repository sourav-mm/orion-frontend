...
import "./OtherGeneralItems.css";
import FavoriteBorderIcon from "@mui/icons-material/FavoriteBorder";

function OtherGeneralItems() {
              ...
              {addprd.map((addprd) => (
                ...
                >
                  ...
                  <Card.Body>
                    ...
                    <Link to={`/OtherGeneralItemsProduct/${addprd._id}`}>
                      <Button
                        variant="primary"
...
export default OtherGeneralItems;
