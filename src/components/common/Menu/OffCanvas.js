      ...
      >
        ...
        <div className="offcanvas-content">
          ...
          <div className="offcanva-details">
            <p>
              Unlock an array of customization possibilities and seamless
              compatibility with Elementor, empowering users to craft stunning
              websites effortlessly with Valiance.
            </p>
          </div>
        ...
        <div className="tp-footer__widget pb-30 offcanvas-ct-info">
          ...
          <ul>
            <li>
              <Link to="#">11th FLOOR, FUJAIRAH TOWER, FUJAIRAH, UAE</Link>
            </li>
            <li>
              <Link to="tel:+88015569569365">+9714 283 1148</Link>
            </li>
            <li>
              <Link to="mailto:support@example.com"> sales@orionworld.co</Link>
            </li>
          </ul>
        </div>
      </div>
