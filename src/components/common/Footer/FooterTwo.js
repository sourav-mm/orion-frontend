                ...
                <div className="row">
                  <div className="col-lg-3 col-md-6">
                    <div className="tp-footer__widget tp-footer__2 footer-col-2-1 pb-30">
                      <div className="footer-logo mb-30">
                        <a href="#dd"><img src="/assets/img/logo/logo.png" alt="" /></a>
                      </div>
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div className="tp-footer__widget tp-footer__2 footer-col-2-2 pb-30">
                      ...
                      <ul>
                        <li><a href="#d">London</a></li>
                        <li><a href="#d">America</a></li>
                        <li><a href="#d">Constarica</a></li>
                        <li><a href="#d">Germany</a></li>
                        <li><a href="#d">India</a></li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div className="tp-footer__widget tp-footer__2 footer-col-2-3 pb-30">
                      ...
                      <ul>
                        <li><a href="#d">Ta-134/A, Gulshan Badda Link </a></li>
          ...
          <div className="row">
            ...
            <div className="col-md-4 col-12">
              <div className="tp-footer-social-icon mb-30 text-md-end">
                <ul>
                  <li><a href="#d"><i className="fab fa-facebook"></i></a></li>
                  <li><a href="#d"><i className="fab fa-twitter"></i></a></li>
                  <li><a href="#d"><i className="fab fa-instagram"></i></a></li>
                  <li><a href="#d"><i className="fab fa-youtube"></i></a></li>
                  <li><a href="#d"><i className="fab fa-linkedin"></i></a></li>
                </ul>
              </div>
            </div>
          </div>
