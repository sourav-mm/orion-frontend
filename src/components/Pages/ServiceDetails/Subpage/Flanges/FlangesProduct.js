...
const FlangesProduct = () => {
  ...
  useEffect(() => {
    AXIOS.get(`http://orion-frontend-api.vercel.app/getFlangesProduct/${id}`)
      .then((result) => {
        console.log(result);
  ...
  const handleFormSubmit = async () => {
    await AXIOS.post("http://orion-frontend-api.vercel.app/flanges", {
