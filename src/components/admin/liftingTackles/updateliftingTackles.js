...
const UpdateliftingTackles = () => {
  ...
  const updateliftingTackles = async (e) => {
    e.preventDefault();
      ...
      >
        ...
        <Container>
          <div className="d-flex vh-100  justify-content-center align-items-center">
            ...
            >
              <Form onSubmit={updateliftingTackles}>
                <Form.Group>
...
export default UpdateliftingTackles;
