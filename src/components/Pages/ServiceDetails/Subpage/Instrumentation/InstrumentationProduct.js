...
const InstrumentationProduct = () => {
  ...
  useEffect(() => {
    AXIOS.get(`http://orion-frontend-api.vercel.app/getInstrumentationProduct/${id}`)
      .then((result) => {
        console.log(result);
  ...
  const handleFormSubmit = async () => {
    await AXIOS.post("http://orion-frontend-api.vercel.app/instrumentation", {
...
export default InstrumentationProduct;