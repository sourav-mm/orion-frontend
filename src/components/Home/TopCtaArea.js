              ...
              <div className="col-lg-9">
                <div className="tp-section-wrapper">
                  ...
                  <h2 className="tp-section-title">
                    From strategic planning to flawless execution, we're
                    committed to ensuring the success of your business journey
                  </h2>
                </div>
              </div>
                ...
                <Link to="/service-details">
                  <div className="tp-theme-btn d-flex align-items-center">
                    <div className="tp-btn-inner">
                      <p className="mb-0">Our Products</p>
                      <b>Inventory Selection</b>
