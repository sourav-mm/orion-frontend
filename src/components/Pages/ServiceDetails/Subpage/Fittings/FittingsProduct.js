...
const FittingsProduct = () => {
  ...
  useEffect(() => {
    AXIOS.get(`http://orion-frontend-api.vercel.app/getFittingsProduct/${id}`)
      .then((result) => {
        console.log(result);
  ...
  const handleFormSubmit = async () => {
    await AXIOS.post("http://orion-frontend-api.vercel.app/fittings", {
...
export default FittingsProduct;