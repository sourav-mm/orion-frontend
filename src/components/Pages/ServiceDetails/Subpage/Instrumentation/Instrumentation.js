              ...
              {addprd.map((addprd) => (
                ...
                >
                  ...
                  <Card.Body>
                    ...
                    <Link to={`/InstrumentationProduct/${addprd._id}`}>
                      <Button
                        variant="primary"
