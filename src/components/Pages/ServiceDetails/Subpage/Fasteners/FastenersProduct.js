...
const FastenersProduct = () => {
  ...
  useEffect(() => {
    AXIOS.get(`http://orion-frontend-api.vercel.app/getFastenersProduct/${id}`)
      .then((result) => {
        console.log(result);
  ...
  const handleFormSubmit = async () => {
    await AXIOS.post("http://orion-frontend-api.vercel.app/fasteners", {
...
export default FastenersProduct;